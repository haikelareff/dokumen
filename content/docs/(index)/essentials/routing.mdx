...
<Files>
    <Folder name="content/docs (content directory)" defaultopen="true">
        <Folder name="(index)" defaultopen="true">

            <File name="index.mdx" />

            <File name="quickstart.mdx" />
        </Folder>
        <Folder name="api-reference" defaultopen="true">

            <File name="index.mdx" />

            <Folder name="(generated)" defaultopen="true">
                <Folder name="events" defaultopen="true">
                    <File name="getSpecialEvent.mdx" />
                    <File name="createSpecialEvent.mdx" />
                </Folder>
                <Folder name="operations" defaultopen="true">
                    <File name="getMuseumHours.mdx" />
                </Folder>
            </Folder>

        </Folder>
        <Folder name="changelog" defaultopen="true">
